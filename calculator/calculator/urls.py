...
from operation.views import AdditionView,SubtractionView,MultiplicationView,DivisionView,FactorialView,PrimenumberView,PerfectNumberView
urlpatterns = [
    ...
    path('perfectnumber/',PerfectNumberView.as_view())
]
